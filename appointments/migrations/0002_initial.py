...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='authorized_party', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='patient',
            name='owner',
        ...
        migrations.AddField(
            model_name='patient',
            name='sponsor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='guarantor', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
